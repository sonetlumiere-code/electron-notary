...
import LegalPersonBulkActions from "./bulk-actions/legal-person-bulk-actions"
import { columns } from "./columns"

interface LegalPersonsDataTableProps {
  data: LegalPersonDataSheet[]
}

export function LegalPersonsDataTable({ data }: LegalPersonsDataTableProps) {
  ...
  return (
    <div className="relative grid gap-4">
      ...
      <div className="flex items-center justify-between px-2 h-9">
        <div className="flex items-center">
          <LegalPersonBulkActions table={table} />
        </div>
