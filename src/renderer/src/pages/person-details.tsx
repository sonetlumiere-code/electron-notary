          ...
          {person && (
            <div className="relative grid gap-6 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="grid gap-1">
                ...
                <p className="text-sm text-muted-foreground">{person.fatherName || "-"}</p>
              </div>
              <div className="grid gap-1">
                <p className="text-sm font-medium leading-none">Nombre de la Madre</p>
                <p className="text-sm text-muted-foreground">{person.motherName || "-"}</p>
              </div>
              <div className="grid gap-1">
                <p className="text-sm font-medium leading-none">Nombre del Cónyuge</p>
                <p className="text-sm text-muted-foreground">{person.spouseName || "-"}</p>
              </div>
              <div className="grid gap-1">
              ...
              <div className="grid gap-1">
                ...
                <p className="text-sm text-muted-foreground">{person.marriageRegime || "-"}</p>
              </div>
              <div className="grid gap-1">
              ...
              <div className="grid gap-1">
                ...
                <p className="text-sm text-muted-foreground">{person.divorceCourt || "-"}</p>
              </div>
              <div className="grid gap-1">
                <p className="text-sm font-medium leading-none">Carátula</p>
                <p className="text-sm text-muted-foreground">{person.divorce || "-"}</p>
              </div>
              <div className="grid gap-1">
                <p className="text-sm font-medium leading-none">Cantidad de Hijos</p>
                <p className="text-sm text-muted-foreground">{person.numberOfChildren ?? "-"}</p>
              </div>
              <div className="grid gap-1">
              ...
              <div className="grid gap-1">
                ...
                <p className="text-sm text-muted-foreground">{person.mobileNumber || "-"}</p>
              </div>
              <div className="grid gap-1">
              ...
              <div className="grid gap-1">
                ...
                <p className="text-sm text-muted-foreground">{person.politicalPosition || "-"}</p>
              </div>
              <div className="grid gap-1">
                <p className="text-sm font-medium leading-none">Origen de Fondos</p>
                <p className="text-sm text-muted-foreground">{person.originOfFunds || "-"}</p>
              </div>
              <div className="grid gap-1">
                <p className="text-sm font-medium leading-none">Referido por</p>
                <p className="text-sm text-muted-foreground">{person.referredBy || "-"}</p>
              </div>
              <div className="grid gap-1">
                <p className="text-sm font-medium leading-none">Observaciones</p>
                <p className="text-sm text-muted-foreground">{person.observations || "-"}</p>
              </div>
